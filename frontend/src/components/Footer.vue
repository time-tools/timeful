<template>
  <footer class="tw:bg-green tw:p-8 tw:text-white">
    <div class="tw:mx-auto tw:max-w-7xl">
      <div class="tw:flex tw:flex-col tw:gap-8 tw:md:grid tw:md:grid-cols-4">
        <!-- Logo and Info -->
        <div>
          ...
          <div class="tw:mb-6 tw:flex tw:items-center tw:space-x-3">
            <a href="https://x.com/timeful_app" aria-label="X" target="_blank">
              <svg
                ...
                viewBox="0 0 512 512"
                class="tw:size-5 tw:fill-current tw:text-white/80 tw:hover:text-white"
              >
                <path
          ...
          <div>
            ...
            >
              <template #activator="{ props }">
                <span
                  class="tw:cursor-pointer tw:text-sm tw:text-white/80 tw:hover:text-white"
                  v-bind="props"
                >
                  Support
                </span>
